...
PERMISSION_TYPE_REASSIGNATION_NAMES = {
    ...
    INPUT.FORM.PERMISSIONS.LABEL.UNPAID_EXTRA_HOURS_PERMISSION: PERMISSION_NAME.UNPAID_EXTRA_HOURS_PERMISSION,
}
"""
...
COLUMN_LABELS: dict[str, str] = {
    ...
    COLUMN.IS_VACATION: 'Es registro en vacaciones del usuario',
