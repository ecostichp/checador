...
class HorizontalSeries(pd.Series):
    ...
    @overload
    def __getitem__(self, key: Literal['year_period']) -> int: ...
    @overload
    def __getitem__(self, key: Literal['hire_date']) -> date: ...
    @overload
    def __getitem__(self, key: Literal['year_validity_date']) -> datetime: ...
